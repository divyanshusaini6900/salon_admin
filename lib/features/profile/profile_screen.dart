  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          const CircleAvatar(radius: 42, backgroundColor: Color(0xFFE7ECF6), child: Icon(Icons.person, size: 40)),
          const SizedBox(height: 12),
          Text(profile?.name ?? 'Admin', textAlign: TextAlign.center, style: Theme.of(context).textTheme.headlineSmall),
          ...
          _BiometricSection(email: profile?.email ?? ''),
          const SizedBox(height: 24),
          ElevatedButton.icon(
            onPressed: () async {
      ...
      child: Row(
        children: [
          Container(
            width: 48,
            height: 48,
            decoration: BoxDecoration(color: const Color(0xFFE7ECF6), borderRadius: BorderRadius.circular(14)),
